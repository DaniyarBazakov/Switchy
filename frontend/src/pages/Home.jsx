  ...
  return(
    ...
    <section className="hero">
      <div className="hero-content">
        <h1>Switch to Your Dream Career with Personalized Roadmaps and Mentorship</h1>
        <p>Switchy is a career transition app designed to support you in switching fields with personalized career roadmaps, curated learning resources, and mentorship from industry professionals.</p>
        <div className="cta-buttons">
          <Link to="/signup" className="btn">Start Your Journey</Link>
    ...
    <section className="how-it-works">
      ...
      <div className="steps">
        <div className="step">
          ...
          <p>Browse various industry-specific career paths tailored to your goals.</p>
        </div>
        <div className="step">
        ...
        <div className="step">
          ...
          <p>Join a community of industry professionals to gain insights and guidance.</p>
        </div>
        <div className="step">
          <h3>Access Curated Learning Resources</h3>
          <p>Get personalized recommendations for courses, articles, and videos.</p>
        </div>
      </div>
    </section>
    ...
    <section className="features">
      ...
      <div className="feature">
        ...
        <p>Take quizzes to assess your skills and receive tailored recommendations.</p>
      </div>
      <div className="feature">
      ...
      <div className="feature">
        ...
        <p>Access personalized learning content to help you switch careers.</p>
      </div>
    </section>
